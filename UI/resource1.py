"""Potential resource if the GUI is ever built. 

This script allows for the creation of a polygon on an image. The polygon can be moved and resized.
Might be transferable to graph building.
