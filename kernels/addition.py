"""
Created on Mon Dec  9 16:45:46 2019

addition.py - Define kernel for adding scalars and tensors
...
class AdditionKernel(Kernel):
    """
    Kernel to add two BCIPP data containers (i.e. tensor or scalar)
    together
    """
    ...
    @classmethod
    def addAdditionNode(cls,graph,inA,inB,outA):
        """
