                ...
                if n.kernel.init_style == BcipEnums.INIT_FROM_DATA:
                    ...
                    for n_i, n_ii in zip(n.kernel.inputs, n.kernel.init_inputs):
                        if n_ii.virtual and n_ii.shape == ():
                            ...
                            init_provided = e.find_upstream_init_data()
...
class Edge:
    ...
    def insert_init_data(self):
        ...
        self._init_data = Tensor.create_virtual(self._sess)
        self._init_labels = Tensor.create_virtual(self._sess)
        ...
        for p in self.producers:
            ...
            p.kernel.init_labels = self.init_labels
        ...
        for c in self.consumers:
            ...
            if c.kernel.init_inputs[input_index] is None:
                ...
                c.kernel.init_labels = self.init_labels
    ...
    def find_upstream_init_data(self, edges):
        ...
        for n_i, n_ii in zip(p.kernel.init_inputs, p.kernel.init_input_indices):
            if n_ii.virtual and n_ii.shape == ():
