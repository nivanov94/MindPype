...
class Classifier(BCIP):
    ...
    >>> classifier_object = Classifier.create_LDA(sess, solver='svd', shrinkage=None, priors=None, n_components=None, store_covariance=False, tol=0.0001)
    ...
    def create_SVM(cls, sess, C=1, kernel="rbf", degree=3, gamma="scale", coef0=0, shrinking=True, probability=False, tol=0.001, cache_size=200, class_weight=None, verbose=False, max_iter=-1, decision_function_shape="ovr", break_ties=False, random_state=None):
        ...
        .. note:: All other parameters are the same as the `sklearn.svm.SVC object <https://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html>`_
